...
export class AuthenticationService {
  ...
  register(user: any) {
    ...
    return this.http.post('http://127.0.0.1:8000/api/register', params, { headers: headers });
  }
  ...
  updateUser(user: any) {
    ...
    let params = 'json=' + json;
    let headers = new HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded');
    return this.http.post('http://127.0.0.1:8000/api/updateUser', params, { headers: headers });
  }
}
